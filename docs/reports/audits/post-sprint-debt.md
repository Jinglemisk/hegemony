...
identical content. `docs/archive/roadmap-appendix.md:132` still lists it as "needs a home". Its
...
- `src/components/board/helpers.ts:166` — `formatTileName()`. Note
  `docs/reports/audits/components.md:108` **already ordered this deleted**; it survived.
...
**Stale-document caveat:** `docs/reports/audits/components.md` references
