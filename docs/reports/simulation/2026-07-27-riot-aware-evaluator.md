...
(`ce180bed2c3d`) with the revised evaluator candidate (`e087366e0e7d`).
...
| beam vs greedy | final calm / unrest / revolt share | 71.9% / 6.3% / 12.5% | 84.1% / 4.5% / 4.5% |
...
| beam vs smart | final calm / unrest / revolt share | 54.5% / 20.5% / 11.4% | 84.4% / 0.0% / 6.3% |
...
one-ply smart, resolved fewer riots in both matchups, and ended much more often
in calm positions. Focused fixtures separately prove that smart and beam reject
an unsafe promotion while retaining the supported equivalent.
