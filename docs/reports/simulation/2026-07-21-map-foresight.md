...
*Built on top of Phase 3-C
([influence-aware AI plan](../../archive/plans/influence-aware-ai.md)). A sim-bot
...
`docs/reports/simulation/2026-07-21-influence-aware-ai.md` names this exact blind spot.
...
Measured across a full weight sweep ([write-up](2026-07-21-settler-vs-smart.md)).
...
- `docs/reference/simulation.md` — the `settler` policy.
- `docs/reports/simulation/2026-07-21-settler-vs-smart.md` — the A/B write-up.
