...
| Doc | What it is |
|---|---|
| **[Simulation reference](../../reference/simulation.md)** | The command reference — every `sim` subcommand, flag, and report field. Read this to *run* a sim. |
| **[AI reference](../../reference/ai.md)** | How the bots work: the policy seam, determinism contract, evaluators, and tuning loop. Read this to *change* a bot. |
