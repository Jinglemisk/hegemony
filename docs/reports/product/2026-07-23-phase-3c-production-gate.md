...
Evidence: [Phase 3-C result](../simulation/2026-07-21-influence-aware-ai.md),
[AI limits](../../reference/ai.md),
[legal move protocol](../../../src/game/legalMoves.ts), and
...
were recorded in [the archived roadmap appendix](../../archive/roadmap-appendix.md):
coastal geometry (Q31),
luxury rules/pricing (Q32), and trade shape (Q33).

There are design contradictions to settle before implementation:

- The original [luxury plan](../../plans/luxury-goods.md) says every good gives +2 standing
  happiness; [terrain-economy](../../archive/plans/terrain-economy.md) adds diminishing duplicate copies
