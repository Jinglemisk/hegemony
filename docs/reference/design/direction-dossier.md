...
**Axes.**
- *Abstract ↔ direct:* direct-but-emblematic. Real ceramic tokens on tiles, engraved line glyphs, zero illustration on terrain (honors the rollback in `docs/archive/notes/resource-color-rollback-note.md`).
