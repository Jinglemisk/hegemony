...
| **5**   | Proposed               | National Ideas and local setup screen; networking and 2–3-player scaling require separate plans             | Ideas have no automatic pick; setup is usable without URL editing                                                                |
