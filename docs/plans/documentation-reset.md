...
| `docs/roadmap-appendix.md` | Retire after extracting unresolved questions; move intact to `docs/archive/roadmap-appendix.md`.                    |
| `docs/todo.md`             | Retire after assigning every live item to the roadmap, questions, or a plan; move intact to `docs/archive/todo.md`. |

### Active plans

| Current path                          | Proposed destination                                                             |
| ------------------------------------- | -------------------------------------------------------------------------------- |
| `docs/feat/luxury-goods.md`           | `docs/plans/luxury-goods.md`                                                     |
| `docs/feat/outcome-driven-ai-plan.md` | `docs/plans/outcome-driven-ai.md`                                                |
| `docs/sim/plan.md`                    | Fold still-valid campaigns into the active Phase 3.5 plan; archive the original. |
...
| Current path                                        | Proposed destination                         |
| --------------------------------------------------- | -------------------------------------------- |
| `docs/ai.md`                                        | `docs/reference/ai.md`                       |
| `docs/simulation.md`                                | `docs/reference/simulation.md`               |
| `docs/v0.1-rules-spec.md`                           | `docs/reference/v0.1-rules-spec.md`          |
| `docs/design/README.md`                             | `docs/reference/design/README.md`            |
| `docs/design/direction-dossier.md`                  | `docs/reference/design/direction-dossier.md` |
| `docs/design/brandbook-v0.1.html`                   | `docs/reference/design/brandbook-v0.1.html`  |
| `docs/design/showcases/`                            | `docs/reference/design/showcases/`           |
...
| Current path                                  | Proposed destination                                          |
| --------------------------------------------- | ------------------------------------------------------------- |
| `docs/2026-07-23-phase-3c-production-gate.md` | `docs/reports/product/2026-07-23-phase-3c-production-gate.md` |
| `docs/design/state-of-the-game-2026-07-23.md` | `docs/reports/product/2026-07-23-state-of-the-game.md`        |
| `docs/design/audits/*.md`                     | `docs/reports/audits/`                                        |
| `docs/design/architecture-report.html`        | `docs/reports/audits/architecture-report.html`                |
| `docs/initial-round-balance.md`               | `docs/reports/balance/initial-round-balance.md`               |
| `docs/sim/2026-*.md`                          | `docs/reports/simulation/`                                    |
| `docs/sim/README.md`                          | `docs/reports/simulation/README.md`                           |
| `docs/feat/ai-bot-parity.md`                  | `docs/reports/audits/2026-07-23-ai-bot-parity.md`             |
| `docs/feat/map-foresight.md`                  | `docs/reports/simulation/2026-07-21-map-foresight.md`         |
...
- `docs/feat/codex-rules.md`
- `docs/feat/event-cards.md`
- `docs/feat/event-tables.md`
- `docs/feat/influence-aware-ai.md`
- `docs/feat/seasons.md`
- `docs/feat/terrain-economy.md`
- `docs/feat/two-panel.md`
...
- `docs/OVERNIGHT.md`
- `docs/resource-color-rollback-note.md`
- `docs/rules-archive.md`
- the original `docs/sim/plan.md`
