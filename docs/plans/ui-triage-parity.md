...
| PAR-ASM-11 | —       | —        | The repeal crack-and-fall ceremony. **KNOWN-OMISSION**: an exit animation needs retained departed-law state, so it was deferred rather than half-built.                                                   |
