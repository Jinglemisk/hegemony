...
understand) and [the simulation reference](../../reference/simulation.md) (the harness
that verifies it).*
...
- **`docs/reference/simulation.md`** — document `--policy political`.
- **`docs/archive/roadmap-appendix.md` / roadmap** — mark 3-C built; record the A/B result.
...
recommendations** (like `docs/reports/simulation/2026-07-13-victory-minimums.md`) — **recorded, not
...
- Sim-backed tuning notes on the `Ruleset.assembly` dials filed under `docs/reports/simulation/`.
