...
archived: 2026-07-26
shipping_evidence: "PRs #36, #38, and #39; embedded build record"
...
Feeds / supersedes: `docs/archive/roadmap-appendix.md` (Q27–Q29), `docs/archive/notes/rules-archive.md`, `seasons.md`,
`docs/archive/plans/two-panel.md`, `docs/archive/plans/event-tables.md`, `docs/reports/simulation/2026-07-18-greedy-vs-smart.md`,
`todo.md`. **Approved visual reference (owner, 2026-07-20): `docs/reference/design/showcases/assembly-mode-showcase.html`**
...
Fills a **proven** hole. The greedy-vs-smart sim (`docs/reports/simulation/2026-07-18-greedy-vs-smart.md`) showed the
