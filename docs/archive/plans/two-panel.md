...
archived: 2026-07-26
shipping_evidence: "PRs #27 and #35"
---
...
*that*. The greedy-vs-smart sim (`docs/reports/simulation/2026-07-18-greedy-vs-smart.md`) showed the
...
Grows out of the KYKLOS refit (`docs/archive/plans/ui-refit.md`) — same grammar (full-bleed sea,
