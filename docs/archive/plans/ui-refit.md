...
archived: 2026-07-26
shipping_evidence: "PRs #22–#24"
---

# Phase 1.5 — the interface refit · build plan

> The appendix (`docs/archive/roadmap-appendix.md:68`) says: *"Gets `docs/archive/plans/ui-refit.md`
...
1. **Read the two references.** `docs/reference/design/showcases/DECIDED-UI-LAYOUT.html` — the
   ratified layout mock, codename KYKLOS, **mode A** (ignore the A/B/C toggle; A is
   the target). And `docs/reference/design/showcases/hegemony-target-mock.html` — a rough but
...
The layout is **`docs/reference/design/showcases/DECIDED-UI-LAYOUT.html`** — codename **KYKLOS,
...
2. **Screenshot the visual.** Serve (`python3 -m http.server` in the build output, or
   ...
   `docs/reference/design/showcases/hegemony-target-mock.html`. **This is mandatory for anything
...
- **In-repo, durable:** `docs/reference/design/showcases/DECIDED-UI-LAYOUT.html` (KYKLOS, mode A
  = target) and `docs/reference/design/showcases/hegemony-target-mock.html` (our reconciled
